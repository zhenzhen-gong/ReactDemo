    ...
    renderEditArea() {
        return (
            <div className="orderItem__commentContainer">
                ...
                {this.renderStarts()}                
                <button className="orderItem__btn orderItem__btn--red" onClick={this.handleCommit}>提交</button>
                <button className="orderItem__btn orderItem__btn--grey" onClick={this.handleCancelCommit}>取消</button>
            </div>
        )
    }
